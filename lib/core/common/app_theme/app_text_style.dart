...
abstract class AppTextStyle {
  ...
  static const appColor25 = TextStyle(fontSize: 25, color: AppColors.appColor);
  ...
  static const appColor18 = TextStyle(fontSize: 18, color: AppColors.appColor);
  ...
  static const appColor16 = TextStyle(fontSize: 16, color: AppColors.appColor);
  ...
  static const appColor23 = TextStyle(fontSize: 23, color: AppColors.appColor);
